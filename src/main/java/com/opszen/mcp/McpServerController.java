...
public class McpServerController {
    ...
    @Value("${opszen.mcp.version}")
    private String protocolVersion;

    @Value("${opszen.mcp.server-name}")
    private String serverName;

    @Value("${opszen.mcp.server-version}")
    private String serverVersion;

    public McpServerController(McpToolRegistry registry, ObjectMapper objectMapper, OpsZenMetrics metrics) {
